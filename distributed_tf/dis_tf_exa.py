...
parameter_servers = ["172.20.181.20:2222"]
workers = ["172.20.181.12:2222",
           "172.20.181.16:2222",
           "172.20.181.23:2222"]
...
if FLAGS.job_name == "ps":
    ...
    with tf.device(tf.train.replica_device_setter(
        ...
        dense_layer1 = tf.layers.dense(x, 100, activation=tf.nn.sigmoid,
                                       kernel_initializer=tf.random_normal_initializer(0, 0.1))
        logits = tf.layers.dense(dense_layer1, 10, kernel_initializer=tf.random_normal_initializer(0, 0.1))
